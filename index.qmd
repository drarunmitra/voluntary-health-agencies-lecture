...
Content verified against Park's *Preventive and Social Medicine*.
:::
...
- State Park's definition of a voluntary health agency and its characteristics
...
## Ask the class {.smaller}

::: {.callout-tip appearance="simple"}
<b>Ask:</b> Name a health NGO you have heard of. What does it do, and where does its money come from?
:::

. . .

Hold that example. We will place it against Park's formal definition next.

# 1 · Definition and characteristics {.inverse background-color="#222222"}

## Park's definition {.smaller}
...
::: {.callout-note appearance="simple"}
This is the examinable definition. Copy it verbatim.
:::

## Scale and the "motor truck" analogy
...
## Voluntary vs government agency {.smaller}
...
# 2 · Park's six functions {.inverse background-color="#222222"}
...
# 3 · Indian voluntary health agencies {.inverse background-color="#222222"}

## 1 · Indian Red Cross Society (1920) {.smaller}
...
## 2 · Hind Kusht Nivaran Sangh (1950) {.smaller}
...
## 3 · Indian Council for Child Welfare (1952) {.smaller}
...
## 4 · Tuberculosis Association of India (1939) {.smaller}
...
## 9 · All India Women's Conference (1926) {.smaller}
...
## 10 · All-India Blind Relief Society (1946) {.smaller}

- Coordinates institutions working for the blind.
- Organises **eye relief camps**.

## 11 · Professional bodies {.smaller}
...
# 4 · International and bilateral agencies {.inverse background-color="#222222"}
...
## Beyond Park's classic list {.smaller}
...
# 5 · Role and accountability {.inverse background-color="#222222"}
...
## Formative MCQs {.smaller}

::: {.callout-tip appearance="simple"}
1. Which function does the Rockefeller bore-hole latrine exemplify?
2. In which year was the Indian Red Cross Society founded?
3. Is CARE an inter-governmental agency?
:::

. . .

::: {.callout-note}
**Answers:** 1 — Demonstration (function d). 2 — 1920. 3 — No; it is a voluntary, non-profit agency.
:::
...
# Thank You {.inverse background-color="#222222" -}
